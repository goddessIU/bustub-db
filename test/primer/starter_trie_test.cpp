...
TEST(StarterTest, TrieInsert1Test) {
  Trie trie;
  trie.Insert<std::string>("abc", "d");
}

TEST(StarterTest, TrieInsert2Test) {
  Trie trie;
  trie.Insert<std::string>("a", "e");
  trie.Insert<int>("ab", 2);
  trie.Insert<std::string>("abc", "d");
}

TEST(StarterTest, TrieInsert3Test) {
  Trie trie;
  trie.Insert<std::string>("abc", "d");
  bool success = true;
...
TEST(StarterTest, TrieInsert4Test) {
  Trie trie;
...
TEST(StarterTest, TrieInsert5Test) {
  Trie trie;
...
TEST(StarterTest, TrieInsert6Test) {
  Trie trie;
...
TEST(StarterTrieTest, Remove1Test) {
  Trie trie;
  bool success = trie.Insert<int>("a", 5);
  EXPECT_EQ(success, true);
...
TEST(StarterTrieTest, Remove2Test) {
  Trie trie;
  bool success = trie.Insert<int>("a", 5);
  EXPECT_EQ(success, true);
  success = trie.Insert<int>("aa", 6);
